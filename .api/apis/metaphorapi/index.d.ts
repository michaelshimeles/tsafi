...
declare class SDK {
    ...
    /**
     * Perform a search with a Exa prompt-engineered query and retrieve a list of relevant
     * results. Optionally get contents.
     *
     * @summary Search
     */
     ...
     *
     */
    getContents(body: types.GetContentsBodyParam): Promise<FetchResponse<200, types.GetContentsResponse200>>;
}
